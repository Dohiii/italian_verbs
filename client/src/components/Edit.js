...
function AddVerb() {
  ...
  const chasownikRef = useRef(null)
  const tlumaczenieRef = useRef(null)
    ...
    async function fetchPosts() {
      try {
        const response = await fetch(
          `https://italian-verbs.onrender.com/api/v1/admin/${id}`, {
  ...
  function loopAndPopulateForm(arr, data) {
    arr.forEach(osoba => {
      try {
  ...
  const populateForm = async (data) => {
    ...
    loopAndPopulateForm(sectionIndicativoArr, data)
    loopAndPopulateForm(sectionCongiuntivoArr, data)
    loopAndPopulateForm(sectionCondizionaleArr, data)
    loopAndPopulateForm(sectionImperativoArr, data)
          ...
          <section className="top-container">
            ...
            <div className="zwrotne_checkboxes">
              <div className="checkbox-wrapper-32 zwrotne">
                <input type="radio" name="checkbox_zwrotne" id="zwrotne-tak" onChange={e => setZwrotny(true)} ref={zwrotnyRef} />
              ...
              <div className="checkbox-wrapper-32 zwrotne">
                <input type="radio" name="checkbox_zwrotne" id="zwrotne-nie" checked={true} onChange={e => setZwrotny(false)} ref={zwrotnyRef} />
